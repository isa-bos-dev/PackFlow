...
import { Package, HelpCircle } from '../common/Icons';

const Header = ({ step, onBack, onOpenInfo }) => {
    return (
            ...
            <div className="max-w-7xl mx-auto flex justify-between items-center">
                ...
                <div className="flex items-center gap-2 cursor-pointer" onClick={onBack}>
                    ...
                    <div>
                        ...
                        <p className="text-xs text-slate-400 hidden sm:block">Load Calculator v1.0.0</p>
                    </div>
                </div>
